package com.capgemini.userService.jwt.filter;

import com.capgemini.userService.Service.AppUserService;
import com.capgemini.userService.Service.AppUserServiceImpl;
...
public class JWTFilter extends OncePerRequestFilter {
    ...
    protected boolean shouldNotFilter(HttpServletRequest request) throws ServletException {
        String[] allowedUrls = {"/user/login","/user/register", "/user/verify/**"};
